...
abstract class REST_Controller extends CI_Controller {
    ...
    public function response($data = NULL, $http_code = NULL)
    {
        ...
        if($saveRequestToserver_arr != NULL && $saveRequestToserver_arr["is_request"]){
            ...
            $error=(isset($data["errors"]))?$data:array();
        ...
        // If the HTTP status is not NULL, then cast as an integer
         ## *****Inci_Code ******* Remove Null String into response Start********
       $str = json_encode($data,true);
       $null='""';
       $result= str_replace("null", $null, "$str");
       $data=json_decode($result);
       ## *****Inci_Code ******* Remove Null String into response End********
        if ($http_code !== NULL)
        {
