...
class MY_Loader extends CI_Loader {
	...
	function script_tag(){
		$script_text = func_get_args();
foreach($script_text as $script){
			$this->_script_tag .= $script;
		}
   ...
   function _ci_autoloader($basepath = NULL)
   {
	...
	function plugin($plugin_array)
	{
		foreach($plugin_array as $key => $plugin)
		{
			switch($plugin){
					case "datatable":
//					$this->load->css('assets/global/plugins/select2/select2.css');
//					$this->load->css('assets/global/plugins/datatables/extensions/Scroller/css/dataTables.scroller.min.css');
//					$this->load->css('assets/global/plugins/datatables/extensions/ColReorder/css/dataTables.colReorder.min.css');
//					$this->load->css('assets/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.css');
//					$this->load->js('assets/global/plugins/select2/select2.min.js');
//					$this->load->js('assets/global/plugins/datatables/media/js/jquery.dataTables.min.js');
//					$this->load->js('assets/global/plugins/datatables/extensions/TableTools/js/dataTables.tableTools.min.js');
//					$this->load->js('assets/global/plugins/datatables/extensions/ColReorder/js/dataTables.colReorder.min.js');
//					$this->load->js('assets/global/plugins/datatables/extensions/Scroller/js/dataTables.scroller.min.js');
//					$this->load->js('assets/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.js');
//					$this->load->js('assets/admin/pages/scripts/table-advanced.js');
//					$this->load->script_tag('TableAdvanced.init();');
					break;
			}
		}
	}
