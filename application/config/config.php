...
//    print_r($exception);
//    echo '</pre>';
    $responce['error'][] = array('error'=>'500','message'=>'Internal Server Error');
...
$config['proxy_ips'] = '';
define('SITE_NAME','');
define("CUSTOMER_PROJECT_ID","EVC_95137");
define("CUSTOMER_PROJECT_URL","http://dev5.demo4site.com/api_docs/jsonapi/add_json_api");
define('SITE_LOGO',$config['base_url']  .'assets/images/ettract.png');
define('SITE_INDEX', '');
